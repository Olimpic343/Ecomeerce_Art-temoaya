        ...
        <div class="row gy-xl-0 gy-3">
            ...
            <div class="col-xl-6">
                <div class="banner-contain-3 hover-effect">
                    <img src="../assets/images/veg-3/banner/1.png" class="bg-img img-fluid" alt="Verduras frescas">
            ...
            <div class="col-xl-6">
                <div class="banner-contain-3 hover-effect">
                    <img src="../assets/images/veg-3/banner/2.png" class="bg-img img-fluid" alt="Frutas saludables">
