        ...
        <div class="row g-4">
            ...
            <div class="col-xxl-6 col-md-8">
                <div class="home-contain h-100">
                    <img src="../assets/images/veg-3/home/1.png" class="img-fluid bg-img blur-up lazyload" alt="Banner principal">
                    <div class="home-detail home-width p-center-left position-relative">
                        <div>
                            ...
                            <p class="d-sm-block d-none">Envío gratis en todos tus pedidos. Nosotros entregamos, tú disfrutas.</p>
                            <button onclick="location.href = 'shop-left-sidebar.html';" class="btn mt-sm-4 btn-2 theme-bg-color text-white mend-auto btn-2-animation">
                                Comprar ahora
                            </button>
                        </div>
                    </div>
            ...
            <div class="col-xxl-3 col-md-4 ratio_medium d-md-block d-none">
                <div class="home-contain home-small h-100">
                    <div class="h-100">
                        <img src="../assets/images/veg-3/home/2.png" class="img-fluid bg-img blur-up lazyload" alt="Banner lateral">
                    </div>
            ...
            <div class="col-xxl-3 ratio_65 d-xxl-block d-none">
                <div class="row g-3">
                    ...
                    <div class="col-xxl-12 col-sm-6">
                        <div class="home-contain">
                            <a href="shop-left-sidebar.html">
                                <img src="../assets/images/veg-3/home/3.png" class="img-fluid bg-img blur-up lazyload" alt="Estilo orgánico">
                            </a>
                            <div class="home-detail text-white p-center text-center">
                                <div>
                                    <h4 class="text-center">Estilo de vida orgánico</h4>
                                    <h5 class="text-center">Mejores ofertas del fin de semana</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-12 col-sm-6">
                        <div class="home-contain">
                            <a href="shop-left-sidebar.html">
                                <img src="../assets/images/veg-3/home/4.png" class="img-fluid bg-img blur-up lazyload" alt="Seguridad alimentaria">
                            </a>
                            <div class="home-detail text-white w-50 p-center-left home-p-sm">
                                <div>
                                    <h4 class="fw-bold">Alimentos seguros salvan vidas</h4>
                                    <h5>Oferta de descuento</h5>
                                </div>
                            </div>
                        </div>
                    </div>
